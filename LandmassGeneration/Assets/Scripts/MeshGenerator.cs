...
{
    public static MeshData GenerateTerrainMesh(float[,] _heightMap, float _height, AnimationCurve _heightCurve)
    {
        ...
        for(int y = 0; y < height; y++)
        {
            ...
            {
                meshData.verticies[vertexIndex] = new Vector3(topLeftX + x, _heightCurve.Evaluate(_heightMap[x, y]) * _height, topLeftZ - y);
